 ...
 * @param {Object|string} location - Location object with lat, lng, and optional address OR location string
...
export const openMapsNavigation = async (location) => {
  try {
    ...
    if (typeof location === 'string') {
      // If location is a string, try to parse it or just open search
