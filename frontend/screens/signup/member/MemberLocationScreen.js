...
const LocationInputScreen = ({ navigation, route }) => {
  const { email, accessToken, phone, name, gender, dob, interests } = route.params || {};
  const [location, setLocation] = useState('');

  const handleNext = () => {
    navigation.navigate('MemberProfilePic', { email, accessToken, phone, name, gender, dob, interests, city: location });
  };
        ...
        <View style={styles.header}>
          ...
          <View style={styles.progressSection}>
            ...
            <View style={styles.progressBarContainer}>
              {/* 60% filled since it's Step 3 of 5 */}
