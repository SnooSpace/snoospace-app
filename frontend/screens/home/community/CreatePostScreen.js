...
const CommunityCreatePostScreen = ({ navigation, route }) => {
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.captionContainer}>
          <TextInput
            ...
            placeholder="Share updates about your community..."
        ...
        <View style={styles.guidelinesContainer}>
          ...
          <Text style={styles.guideline}>• Share community events and updates</Text>
          <Text style={styles.guideline}>• Tag relevant members and sponsors</Text>
          <Text style={styles.guideline}>• Keep content relevant to your community</Text>
          <Text style={styles.guideline}>• Encourage member engagement</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
