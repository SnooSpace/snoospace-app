...
const VenueCreatePostScreen = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Create Venue Post</Text>
        <TouchableOpacity
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.captionContainer}>
          <TextInput
            ...
            placeholder="Showcase your venue and events..."
        ...
        <View style={styles.guidelinesContainer}>
          ...
          <Text style={styles.guideline}>• Showcase your venue space and amenities</Text>
          <Text style={styles.guideline}>• Tag communities and sponsors you work with</Text>
          <Text style={styles.guideline}>• Share upcoming events and availability</Text>
          <Text style={styles.guideline}>• Highlight your venue's unique features</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
export default VenueCreatePostScreen;
