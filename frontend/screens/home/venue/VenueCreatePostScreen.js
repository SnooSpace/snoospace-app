...
export default function VenueCreatePostScreen({ navigation }) {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      console.log('Creating venue post:', {
        caption,
        images,
        taggedEntities,
        authorType: 'venue'
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.authorInfo}>
            ...
            <View style={styles.authorDetails}>
              <Text style={styles.authorName}>Mumbai Convention Center</Text>
              <Text style={styles.authorType}>Venue</Text>
            </View>
          </View>
          ...
          <View style={styles.captionContainer}>
            <TextInput
              ...
              placeholder="Showcase your venue space, share events you've hosted, or highlight your facilities..."
              value={caption}
          ...
          <View style={styles.tagSection}>
            <Text style={styles.sectionTitle}>Tag Communities & Sponsors</Text>
            <EntityTagSelector
              onEntitiesSelected={handleEntityTag}
              placeholder="Tag communities, sponsors, or other venues"
            />
          </View>
          ...
          <View style={styles.guidelinesContainer}>
            <Text style={styles.guidelinesTitle}>Venue Post Guidelines</Text>
            <Text style={styles.guidelinesText}>
              • Showcase your venue space and facilities{'\n'}
              • Share events you've hosted successfully{'\n'}
              • Highlight unique features and amenities{'\n'}
              • Tag relevant communities and sponsors{'\n'}
