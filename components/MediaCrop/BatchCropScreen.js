  ...
  const handleDone = useCallback(async () => {
    ...
    try {
      ...
      for (let i = 0; i < imageUris.length; i++) {
        ...
        const isUnvisited = !updatedCropDataMap[i];
        const savedCropData = updatedCropDataMap[i] || {}; // Changed: Do not fallback to cropDataRef.current because that belongs to the currently viewed image!
