...
router.get("/members/profile/face-eligibility", authMiddleware, MemberController.getFaceEligibility);
...
router.get("/colleges/:collegeId/hub", authMiddleware, CollegeController.getCollegeHub);
router.get("/colleges/:collegeId/members", authMiddleware, CollegeController.getCollegeMembers);
router.get("/colleges/:collegeId/communities", authMiddleware, CollegeController.getCollegeCommunities);
