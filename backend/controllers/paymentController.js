              ...
              if (dupeCheck.rows[0].registration_status === 'cancelled') {
                ...
                const reactivated = await client.query(
                  `UPDATE event_registrations
                   ...
                   RETURNING id`,
                  [dupeCheck.rows[0].id, userId, pricing.validatedPromoCode || null, pricing.totalDiscount || 0, qrCodeHash]
                );
                ...
                console.log(
                  `[createOrder] Re-activated cancelled registration ${registrationId} for user ${userId}, event ${eventId} (100% discount)`
                );
              } else {
